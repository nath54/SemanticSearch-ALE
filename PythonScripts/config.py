...
KEY_BASE_DATA_PATH_TO_CONVERT: str = "base_path_data_to_convert"
...
KEY_TESTS_BENCHMARKS_PATHS: str = "tests_benchmarks_paths"
KEY_WEBAPP_PORT: str = "webapp_port"
...
KEY_BENCHMARK_RESULTS_JSON: str = "benchmarks_results_json"
KEY_BENCHMARK_RESULTS_JS: str = "benchmarks_results_js"
KEY_BENCHMARK_DATA_JSON: str = "benchmark_data_json"
...
class Config():
    ...
    def __init__(self, config_path: str) -> None:
        ...
        # Chemin de base où il y a des données à convertir
        self.base_data_to_convert_path: str = cast(str, config_dict[KEY_BASE_DATA_PATH_TO_CONVERT])
        ...
        # Chemin vers les tests/benchmarks
        self.tests_benchmarks_paths: str = cast(str, config_dict[KEY_TESTS_BENCHMARKS_PATHS])

        # Port pour la webapp
        self.webapp_port: int = cast(int, config_dict[KEY_WEBAPP_PORT])

        # Configuration par défaut du moteur de recherche pour la webapp
        ...
        # Chemin vers fichier json de données de benchmark
        self.benchmark_results_path_json: str = cast(str, config_dict[KEY_BENCHMARK_RESULTS_JSON])

        # Chemin vers fichier js à convertir données de benchmark depuis json
        self.benchmark_results_path_js: str = cast(str, config_dict[KEY_BENCHMARK_RESULTS_JS])

        # Chemin vers fichier json qui enregistre des données supplémentaires pour les benchmarks
        self.benchmark_data_json: str = cast(str, config_dict[KEY_BENCHMARK_DATA_JSON])
